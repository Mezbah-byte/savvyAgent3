...
class SuspendedCheck
{
    public function check()
    {
        $CI =& get_instance();

        if ($CI->config->item('site_suspended') !== TRUE) {
            return; // Site is running normally
        }

        // Send 503 header so search engines know it's temporary
            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        <a href="mailto:webmaster@admin.mysavvybd.com" id="dynamicProviderLink" title="webmaster@admin.mysavvybd.com" rel="noopener noreferrer">Contact your hosting provider</a> for more information.
                    </div>
                </div>
            </div>
        </section>
